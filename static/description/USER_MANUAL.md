...
![Portada - Cambio de dia de facturacion](cambio-dia-portada.png "Reemplazar con captura de la pantalla principal del wizard")
...
- Sin prorrateo ni factura puente cuando el dia ya estaba alineado y la proxima fecha de factura sigue en el futuro; solo se registra el cambio y se mantiene la fecha.
